...
const runTest = async () => {
    ...
    try {
        ...
        //TODO get value of position
        
        //TODO get quote for asym withdrawal
        
        //withdraw asym percent
        let amount = 100

        //verify cap table
        let statusMid = await bankless.Status();
        statusMid = statusMid.data
        log.info(tag,"statusPre: ",statusMid)

        //filter by address
        let myCap = statusMid.cap.filter((c)=>{return c.address === address})
        ...
        const bodyWithdraw = {
            ...
            signature: signature,
            message: payload,
            terminalName:statusMid.terminalName,
            amount: amount.toString(),
            type: "lpWithdrawAsym",
        };
        log.info(tag,"bodyWithdraw: ", bodyWithdraw);
        let sessionInfo2 = await pioneer.StartSession(bodyWithdraw);
        sessionInfo2 = sessionInfo2.data;
        // eslint-disable-next-line no-console
        console.log("sessionInfo2: ", sessionInfo2);
        
        
        //TODO verify amount is the same as quote
        
        //TODO verify cap table
